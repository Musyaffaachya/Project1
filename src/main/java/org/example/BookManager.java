...
public class BookManager {
    ...
    public List<Book> findBooksByYear(int tahun) { // Variabel saya ubah menjadi 'tahun' agar lebih sesuai
        if (tahun < 2000 || tahun > 2100) { // Kondisi disesuaikan dengan kode sebelumnya
